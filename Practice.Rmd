...
```{r}
log_model_2 <- stan_glm(home_team_win ~ score_differential.x + 
                                       score_differential.y+ 
                                      spread_line.x, 
                                      data = quarter_score_diff, 
                                      family = binomial,
...
hierarchical_quarter_model_2 <- stan_glmer(home_team_win ~ score_differential.x + 
                                        score_differential.y + spread_line.x + 
                                         (1|game_id), 
                                      data = quarter_score_diff, 
                                      family = binomial,
...
```{r}
log_model_3 <- stan_glm(home_team_win ~ score_differential.x + 
                                        score_differential.y +
                                        score_differential.x.x + spread_line.x, 
                                      data = quarter_score_diff, 
                                      family = binomial,
  chains = 4, iter = 5000*2, seed = 84735, refresh = 0)
```
...
```{r}
pp_check(log_model_3, quarter_score_diff)
```
