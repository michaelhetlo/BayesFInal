...
```{r}
game_pred <- posterior_predict(hierarchical_quarter_model_3, data.frame(score_differential.x = -8,score_differential.y = -4, score_differential.x.x = -8, game_id = "2021_12_DAL_LV"))
```
