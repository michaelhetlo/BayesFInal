    ...
    dashboardBody(
        tabItems(
            ...
            tabItem(tabName = "methodology",
                    ...
                    p("𝛃0 - The logged odds of winning when the game is a pick’em. 𝛃0 = -.28 which equates to an odds of .76. The odds of winning are less than 1 due to the fact that our outcome accounts for regulations wins."), 
                    ...
                    p("𝛃1 - The increase in logged odds when the spread increases by 1. 𝛃1 = .15 . Every 1 point increase in the spread line increases our odds of winning by 16 percent."),
                    p("𝛃2 - The increase in logged odds when the score differential increases by 1 at the end of the 1st quarter. 𝛃2  = .09. Every 1 point increase in score differential at the end of the first quarter increases our odds of winning by 10 percent."),
                    ...
                    p("𝛃0 - The logged odds of winning when the game is a pick’em and the score is tied after the 2nd quarter. 𝛃0 = -.33 which equates to an odds of .72. The odds of winning are less than 1 due to the fact that our outcome accounts for regulations wins."),
                    p("𝛃1 - The increase in logged odds when the spread increases by 1. 𝛃1 = .13 . Every 1 point increase in the spread line increases our odds of winning by 14 percent."),
                    p("𝛃2 - The increase in logged odds when the score differential increases by 1 at the end of the 2nd quarter. 𝛃2  = .16 Every 1 point increase in score differential at the end of the second quarter increases our odds of winning by 17 percent."),
                    ...
                    p("Accuracy - 85%"),
                    p("𝛃0 - The logged odds of winning when the game is a pick’em and the score is tied after the 3rd quarter. 𝛃0  = -.35 which equates to an odds of .70. The odds of winning are less than 1 due to the fact that our outcome accounts for regulations wins."),
                    p("𝛃1 - The increase in logged odds when the spread increases by 1. 𝛃1  = .11 . Every 1 point increase in the spread line increases our odds of winning by 11 percent."),
                    p("𝛃2 - The increase in logged odds when the score differential increases by 1 at the end of the 3rd quarter. 𝛃2  = .21. Every 1 point increase in score differential at the end of the third quarter increases our odds of winning by 23 percent.")),
